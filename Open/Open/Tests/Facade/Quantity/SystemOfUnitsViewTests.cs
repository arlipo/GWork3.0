...
namespace Open.Tests.Facade.Quantity {
    [TestClass] public class SystemOfUnitsViewTests : ClassTests<SystemOfUnitsView> {
        ...
        //    string Func() => GetRandom.String();
        //    void Test(SystemOfUnits o) { Assert.AreEqual(o.GetType().BaseType, typeof(Metric)); }
        //    Test(new SystemOfUnits());
        //    Test(new SystemOfUnits(Func()));
        //    Test(new SystemOfUnits(Func(), Func()));
        //    Test(new SystemOfUnits(Func(), Func(), Func()));
        //}
